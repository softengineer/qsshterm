...
//            SLOT( fireZModemDetected() ) );
   ...
   // connect( _shellProcess,SIGNAL(receivedData(const char *,int)),this,
    ...
    //connect(this, SIGNAL(onReceivedRemoteData(QByteArray)), this, SLOT(onReceiveBlock(const char *,int)) );
...
void Session::onReceivedRemoteData(QByteArray data) {
    onReceiveBlock(data.data(), data.length());
}
